        ...
        <section className="grid gap-10 lg:grid-cols-[1fr_0.85fr] lg:items-center">
          <div>
            ...
            <p className="mt-5 max-w-2xl text-lg leading-8 text-slate-200">
              Memoire is a personal commercial control tower used beside CRM, spreadsheets, and private notes. See how a B2B or founder-led seller goes from messy notes and pasted email to Today risks, a manager-ready Pipeline Defense Brief, MEDDIC gaps, and outcome learning.
            </p>
