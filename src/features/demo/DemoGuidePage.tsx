        ...
        <div className="flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
          <div>
            ...
            <p className="mt-2 max-w-3xl text-sm leading-6 text-blue-950">
              Memoire is a personal commercial control tower used beside CRM, spreadsheets, and private notes. The demo proves one promise: capture messy sales evidence, let Today expose urgent risks, and copy manager-ready Pipeline Defense answers before Monday review or your next solo sales check-in.
            </p>
          </div>
          <DataModePill
            compact
