...
export function loadInteractiveDemoWorkspace() {
  ...
  const tvPharm: Account = {
    ...
    user_id: DEMO_USER_ID,
    name: 'TV Pharm',
    summary: 'TV Pharm has a VHP / SolidFog opportunity with tender status pending and procurement timeline unclear.',
    industry: 'Pharmaceutical manufacturing',
    status: 'active',
    pain_points: ['VHP sterilization readiness', 'Procurement timeline clarity'],
  ...
  const controlUnion: Account = {
    ...
    user_id: DEMO_USER_ID,
    name: 'Control Union',
    summary: 'Control Union is reviewing a proposal. Their concerns are lead time and local support, and decision ownership is still unclear.',
  ...
  memory.opportunities = [
    ...
    {
      id: 'demo-opportunity-tv-pharm-vhp',
      user_id: DEMO_USER_ID,
    ...
    {
      id: 'demo-opportunity-control-union-proposal',
      user_id: DEMO_USER_ID,
      account_id: controlUnion.id,
    ...
    },
    {
      ...
      title: 'EU-GMP readiness alignment',
      stage: 'active',
      estimated_value: null,
      blocker: null,
  ...
  memory.interactions = [
    ...
    {
      id: 'demo-interaction-tv-pharm-tender',
      user_id: DEMO_USER_ID,
      account_id: tvPharm.id,
      contact_id: null,
      opportunity_id: 'demo-opportunity-tv-pharm-vhp',
      source_capture_id: null,
      interaction_type: 'note',
      ...
      raw_note: 'VHP / SolidFog tender pending. Procurement timeline unclear. No confirmed next action.',
      structured_data: {},
    ...
    },
    {
      ...
      account_id: controlUnion.id,
      contact_id: 'demo-contact-nam',
      opportunity_id: 'demo-opportunity-control-union-proposal',
      source_capture_id: 'demo-capture-control-union',
      interaction_type: 'call',
      occurred_at: controlReviewAt,
      summary: 'Control Union is reviewing the proposal. They are concerned about lead time and local support.',
  ...
  memory.objections = [
    ...
    },
    {
      ...
      opportunity_id: 'demo-opportunity-tv-pharm-vhp',
      contact_id: null,
      source_interaction_id: 'demo-interaction-tv-pharm-tender',
