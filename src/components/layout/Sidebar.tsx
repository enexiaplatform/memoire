...
import { Activity, Banknote, BarChart3, BookOpen, ClipboardList, Database, History, Network, Search, Settings, Sun, Target, X } from 'lucide-react';
...
const globalIcons: Record<string, ReactNode> = {
  ...
  'business-lens': <BarChart3 className="h-5 w-5" />,
