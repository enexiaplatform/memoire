...
Also generate 2-3 short follow-up questions the user might want to ask next, based on the context. Return as JSON:
{
  "answer": "...",
  "suggested_questions": ["...", "...", "..."]
}`;
    ...
    try {
      ...
      parsed.answer = message.content[0].type === 'text' ? message.content[0].text : 'Unable to synthesize answer.';
    }
