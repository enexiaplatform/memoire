...
Assumption note: values, exact close dates, named decision makers, and budget owners are intentionally left blank unless stated in the example. This sample is meant to test brief usefulness, not to claim verified forecast truth.

## 1. Brief Header

- Week / date: Sample week for internal review
- Sales owner: Henry
- Scope: Selected technical B2B / life science opportunities
- Pipeline period: Current quarter / FY review period
- Prepared by: Memoire draft brief
- Data sources reviewed: account notes, opportunity context, action status, blocker notes
...
- Tender / procurement unclear
- Missing decision timeline
- Missing next communication date
...
- Competing vendors, if any

**Objection Debt**

- Objection: tender / procurement uncertainty
- Evidence: tender pending context
- Age if known: missing
- Required proof/action: confirm evaluation timeline, decision criteria, and next communication date
- Owner: Henry
- Status: open
...
Rescue: contact procurement or sponsor to confirm the tender evaluation timeline, committee owner, shortlist date, and whether any technical/commercial gaps remain.
...
- Unresolved technical / service objection
- Missing decision timeline
- Missing decision maker
- Account may go silent if follow-up is not scheduled

**Evidence**

- Customer concern: lead time and local support.
- Requested action: clearer implementation timeline.
- Decision timeline is not confirmed.
...
- Age if known: missing
- Required proof/action: send implementation timeline and support coverage clarification
- Owner: Henry
- Status: open
...
Follow-up: send implementation timeline and ask who owns the final decision and when the internal review will conclude.
...
- Missing technical evaluation criteria
- Weak forecast evidence
...
- Objection: not explicit
- Evidence: no explicit blocker captured
- Age if known: not available
- Required proof/action: clarify evaluation criteria and next decision milestone
- Owner: Henry
- Status: context gap
...
Clarify: ask the customer to confirm evaluation criteria, decision participants, and the next technical or commercial milestone.
...
- Next customer action unclear
- Forecast may rely on account importance rather than evidence
...
- Current stakeholder alignment
- Decision timeline
- Procurement path
- Next confirmed customer action

**Objection Debt**

- Objection: not explicit
- Evidence: no explicit customer blocker captured in sample
- Age if known: not available
- Required proof/action: convert strategic plan into customer-confirmed next action
- Owner: Henry
- Status: context gap
...
Collect evidence: confirm current stakeholder owner, target product scope, decision timing, and the next customer action.
...
- Age if known: not available
- Required proof/action: capture current customer status before keeping in forecast
- Owner: Henry
- Status: unsupported
...
Downgrade or clarify: remove from active forecast unless Henry can capture current customer evidence and a next action this week.
...
Questions for Henry while testing this sample:

- Which deal feels unfairly classified?
- Which deal feels more exposed than expected?
- Which missing context would actually change your weekly actions?
- Which recommended action would you take immediately?
- Which section would you remove from a weekly brief?
