...
const discouragedVisibleText = [
  ...
  { pattern: /User not authenticated/g, label: 'technical auth copy; use sign-in recovery language' },
  { pattern: /Failed to anonymize/g, label: 'technical anonymize error; use retryable user copy' },
  { pattern: /Anonymization error/g, label: 'technical anonymize error; use retryable user copy' },
